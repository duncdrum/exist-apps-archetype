...
*   `version` almost speaks for itself. In Maven `-SNAPSHOT` are development versions. Your first version should always be `1.0-SNAPSHOT`, with the first release subsequently being `1.0`. **Caveat:** If you plan on using node_modules in your generated app your version needs to be a valid [node semantic version](https://docs.npmjs.com/getting-started/semantic-versioning) `1.0.0-SNAPSHOT` will work with both maven and node.
